### Output the model and get accuracy
```python
import pandas as pd
import math
import numpy as np
...
#Selecting files
file_path = r'D:\ImportanFiles\Coding Related\Repositories\Machine Learning project related\Project 2\Data\002796_metadata_utf8.csv'
